...
$id_contrato = $id_contrato_eletivo = $data_assinatura = $autocontratacao = $autocontratacao_concluido = "";
...
if(isset($_GET["chave"]) && !isset($_SESSION["finalizacao_cadastro_iniciado"])){

    $separarChave = explode("_",$_GET["chave"]);

    $id_assinatura = substr($separarChave[0], 9, -10);

    $id_cliente = substr($separarChave[1], 9, -10);
    ...
    if(isset($_SESSION["id_usuario_cadastro"])){

        unset($_SESSION["id_usuario_cadastro"]);

    }

    if(isset($_SESSION["id_plano_cadastro"])){

        unset($_SESSION["id_plano_cadastro"]);

    }

    if(isset($_SESSION["id_assinatura"])){

        unset($_SESSION["id_assinatura"]);
    ...
    if(isset($_SESSION["email_tack"])){

        unset($_SESSION["email_tack"]);

    }

    if(isset($_SESSION["titular_concluido"])){

        unset($_SESSION["titular_concluido"]);

    }

    if(isset($_SESSION["dependente_concluido"])){

        unset($_SESSION["dependente_concluido"]);

    }

    if(isset($_SESSION["assinatura_concluido"])){

        unset($_SESSION["assinatura_concluido"]);

    }    

    if($controller->validarDadosAssinaturaAutocontratacao($id_assinatura, $id_cliente)){

        $_SESSION["plano_concluido"] = true;

        $_SESSION["box_ativo"] = "plano";

        $_SESSION["finalizacao_cadastro_iniciado"] = true;
        ...
        echo '<script> alert("Os dados informados estão inválidos, por gentileza entre em contato com o suporte AZO.");</script>';
...
if(isset($_SESSION["finalizacao_cadastro_iniciado"])){
    ...
    <div class="container">
        ...
        <form class="form-horizontal" id="form-cadastro" acao="reload" info_destino ="assinaturas/form" info_registro="<?php echo $idView;?>">
            ...
            <div class="box-campos box-selecao-titular" style="display:none;"  box="titular">
                ...
                <div class="box-conteudo">
						...
						<div class="form-group">
							...
							<div class="col-sm-12 box-upload-imagem box-upload-imagem-cnpj">
								...
								<input type='text' name='assinatura-anexo_cnpj' size='50' maxlength='200'  class='campo validar form-control upImg' tipo="texto" readonly='readonly' value='<?php echo $anexo_cnpj;?>'>
						...
						<div class="form-group">
							...
							<div class="col-sm-12 box-upload-imagem box-upload-imagem-contratosocial">
								...
								<input type='text' name='assinatura-anexo_contratosocial' size='50' maxlength='200'  class='campo validar form-control upImg' tipo="texto" readonly='readonly' value='<?php echo $anexo_contratosocial;?>'>
						...
						<div class="form-group">
							...
							<div class="col-sm-12 box-upload-imagem box-upload-imagem-cpf">
								...
								<input type='text' name='assinatura-anexo_cpf' size='50' maxlength='200'  class='campo validar form-control upImg' tipo="texto" readonly='readonly' value='<?php echo $anexo_cpf;?>'>
						...
						<div class="form-group">
							...
							<div class="col-sm-12 box-upload-imagem box-upload-imagem-cpf-responsavel-adicional">
								...
								<input type='text' name='responsavel_anexo-anexo_cpf' size='50' maxlength='200'  class='campo validar form-control upImg' tipo="texto" readonly='readonly' value='<?php echo  $controller->res["responsavel_anexo_cpf"][$i];?>'>
						...
						<div class="form-group">
							...
							<div class="col-sm-12 box-upload-imagem box-upload-imagem-residencia">
								...
								<input type='text' name='assinatura-anexo_comprovanteresidencia' size='50'  maxlength='200'  class='campo validar form-control upImg' tipo="texto" readonly='readonly' value='<?php echo $anexo_comprovanteresidencia;?>'>
                ...
                if(
                    $termo_adesao != 1 ||
                    $termo_adesao == 1 && $autocontratacao == 1 && $autocontratacao_concluido == 0
                ){ 
            ...
            <div class="box-campos box-selecao-contrato" style="display:none;" box="assinatura">
                ...
                <div class="box-conteudo">
                    ...
                    <?php if($termo_adesao != 1  || $termo_adesao == 1 && $assinatura_digital_titular == ""){ ?> 
                    ...
                    <?php if($termo_adesao == 1){ ?> 
                        ...
                        <?php if($autocontratacao_concluido == 0){ ?>

                            <div class="col-sm-12">
                            
                                <p><label class="control-label">Confirmação de conclusão cadastral</label><br>
                                    
                                <input name='assinatura-autocontratacao_concluido' class='validar campo'  type='checkbox'value="1"/>
                                
                                Confirmo que todos os campos, dados como obrigatórios foram preenchidos corretamente com informações verdadeiras.</p>
                        ...
                        <?php }else{ ?>
                            ...
                            <p align="justify">Estamos muito felizes em tê-lo conosco! Agora, enviaremos um e-mail contendo as instruções de uso de nosos serviços.</p>

                            <p align="justify">Você terá acesso imediato a todos os benefícios que preparamos para facilitar seu dia a dia e trazer ainda mais bem-estar para você e sua família.</p> 
                ...
                <?php }else if($termo_adesao == 1){ ?>
                    ...
                    <?php if($autocontratacao_concluido == 0){ ?>
                        ...
                        <div align="center">
                            ...
                            <a href="javascript:void(0);" class="salvar finalizar-cadastro effect-transition-element">Confirmar conclusão cadastral</a>
